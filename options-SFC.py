...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--stream_sensor', default='SFC_S_fixed', help='stream dataset')
        self.parser.add_argument('--rain_sensor', default='SFC_R_fixed', help='rain dataset')
