...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--stream_sensor', default='Saratoga_S_fixed', help='stream dataset')
        self.parser.add_argument('--rain_sensor', default='Saratoga_R_fixed', help='rain dataset')
        ...
        self.parser.add_argument('--model', type=str, default="Saratoga_withRain", help='model label')
